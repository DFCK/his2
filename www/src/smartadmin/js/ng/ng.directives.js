...
//                return 'dashboard/changelang/'+lang.langCode;
//			},
//
...
//				});
////                scope.$apply(function() { $location.path("dashboard/changelang/"+lang.langCode); });
//			}
//		}
//	}])
//;
			...
			link: function(scope, element, attrs, parentCtrls) {
				...
				scope.$watch('active', function(newVal, oldVal) {
					if (newVal) {
						...
						$window.document.title = scope.title +" "+ scope.suftitle;
						scope.setBreadcrumb();
					} else {
