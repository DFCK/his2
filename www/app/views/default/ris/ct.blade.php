<div data-ng-controller="RisCTController">
<div class="row">
    <div class="col-xs-12 col-md-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-cog fa-fw"></i>Phòng CT Scaner
        </h1>
    </div>
...
<div class="col-xs-12 col-sm-4  no-padding">
    <article class="col-xs-12">
        ...
        <div class="jarviswidget jarviswidget-color-blue" id="wid-id-ct0"
...
<div class="col-xs-12 col-sm-8" >
    ...
    <article class="col-xs-12 no-padding">
        ...
        <!-- Widget ID (each widget will need unique ID)-->
        <div class="jarviswidget jarviswidget-color-blue" id="wid-id-ct3"
             data-widget-editbutton="false"
             data-widget-deletebutton="false"
             data-widget-sortable="false"
             data-widget-togglebutton="false"
...
<script>
pageSetUp();
var RisCTController = function ($scope, $filter, $http, ngProgress,$modal) {
...
//        $scope.searcheid = "";
    ...
    $scope.showcdha = function (request) {
        ...
        if(!$scope.status){
            $http.get('ris/loadristemplate/ct/'+request.position)
                .success(function(data){
    ...
    $scope.loadlist = function () {
        if (!$scope.onajax) {
            ...
            $scope.xquangimages =[];
            $scope.PacsInstanceList = [];
            $http.get('ris/loadrisrequest/ct/' + $filter('date')($scope.date, 'dd-MM-yyyy') + "/" + $scope.status)
                .success(function (data) {
                    ngProgress.complete();
