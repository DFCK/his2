    ...
    <div class="row">
        <div class="col-xs-12 col-md-4">
            <h1 class="page-title txt-color-blueDark">
                <i class="fa fa-cog fa-fw"></i>Phòng Nội soi
            </h1>
        </div>
                ...
                <article class="col-xs-12">
                    ...
                    <div class="jarviswidget jarviswidget-color-blue" id="wid-id-sieuam0"
                        ...
                        <header>
                            ...
                            <h2>Danh sách yêu câu Nội soi</h2>
                        </header>
                        <!-- widget div-->
                        <div>
                            <!-- widget content -->
...
<script>
    ...
    var RisSieuamController = function ($scope, $filter, $http, ngProgress) {
        ...
        $scope.show = function (request) {
            ...
            if(!$scope.status){
                $http.get('ris/loadristemplate/noisoi/'+request.position)
...
//                        console.log($scope.sieuamimage);
        ...
        $scope.loadlist = function () {
            if (!$scope.onajax) {
                ...
                $http.get('ris/loadrisrequest/noisoi/' + $filter('date')($scope.date, 'dd-MM-yyyy') + "/" + $scope.status)
                    .success(function (data) {
                        ngProgress.complete();
                        $('.summernote').code("");
                        $scope.sieuamimage = [];
