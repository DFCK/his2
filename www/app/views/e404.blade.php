        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center error-box">
                    <h1 class="error-text-2 bounceInDown animated"> {{trans('common.error')}} 404 <span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span></h1>
                    <h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> {{trans('common.page')}} <u>{{trans('common.not')}}</u> {{trans('common.found')}}</strong></h2>
                    <br />
                    <p class="lead">
                        {{trans('common.errortext')}}
                    </p>
                    <p class="font-md">
                        <b>{{trans('common.errorsearch')}}</b>
                    </p>
                    <br>
